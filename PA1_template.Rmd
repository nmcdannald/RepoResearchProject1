...
Here I'm going to utilize the zoo package to help me with filling NAs with 
an approximate number determined by the function in zoo based on before and 
after values.  If the zoo package is not already installed, you will need to do so now.
```{r}
library(zoo)
actfillna <- zoo(actdf[,], order.by = actdf&date)
